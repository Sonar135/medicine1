...
<?php
    ...
    if(isset($_POST['signup'])){
        ...
        if(invalid_email($email)!== false){
            header("location: patient_auth.php?error=invalidemail");
        //     echo '<div class="message" id="message">
        //     error: INVALID EMAIL
        // </div>';
        exit();
        ...
        if (invalid_password($password)) {
            header("location: patient_auth.php?error=invalid_pass");
            exit();
        ...
        if(pwd_match($password, $confirm)!== false){
            ...
            header("location: patient_auth.php?error=pwd_not_match");
            exit();
        }

        if(email_exists($conn, $email)!== false){
            header("location: patient_auth.php?error=email_in_use");
...
<?php
    ...
    if(emptylogin($email, $password)){
        header("location: patient_auth.php?error=empty_login");
        exit();
    }
    ...
    <div class="container auth">
           ...
           <form action="" method="post" >  <div class="right">
                    ...
                    <div class="n_e">
                        ...
                        <textarea name="medical_records" id="compulsory" cols="30" rows="10" placeholder="medical record (allergies, previous/current medication, health/mental conditions, etc...)"></textarea>
